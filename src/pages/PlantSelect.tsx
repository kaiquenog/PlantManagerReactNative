...
export function PlantSelect() {
    ...
    const [enviromentsSelected, seteEviromentsSelected] = useState('all');
    ...
    function handleEnviromentSelected(enviroment: string) {
        ...
        seteEviromentsSelected(enviroment)
    ...
    function handleFettchMore(distante: number) {
        if (distante < 1)
            return;
            ...
            <View style={styles.plants}>
                <FlatList
                    ...
                    onEndReached={({ distanceFromEnd }) =>
                        handleFettchMore(distanceFromEnd)
                    }
                /*ListFooterComponent={
                   loadingMore
